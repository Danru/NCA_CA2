...
public class DB {
    ...
    //public static String connection = "jdbc:mysql://localhost:3306/library?useUnicode=true&useJDBCCompliantTimezoneShift=true&u\n" +"seLegacyDatetimeCode=false&serverTimezone=UTC&useSSL=false";
    public static Connection getConnection() {
        ...
        try {
            ...
            props.put("password","ThisIsIt!123"); // password all small is default in wb
